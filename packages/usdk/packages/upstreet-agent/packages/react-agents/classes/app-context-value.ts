...
export class AppContextValue {
  ...
  constructor({
    ...
    this.personalAssistantJson = personalAssistantJson;
  ...
  usePersonalAssistantJson() {
    return this.personalAssistantJson;
  }
  useEnvironment() {
